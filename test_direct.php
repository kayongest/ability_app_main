...
<body>
    ...
    <form method="POST" action="/ability_app-master/api/items/create.php" enctype="multipart/form-data">
    ...
    <p><a href="/ability_app-master/api/test.php" target="_blank">Test API Connection</a></p>
    <p><a href="/ability_app-master/test_upload.php" target="_blank">Test Upload Settings</a></p>
</body>
</html>